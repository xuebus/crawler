 ...
 */
public class TransformCoordinateUtil {

    public static boolean isOutOfChina(double lat, double lng) {
    ...
    public static double[] calcGCJ2WGSDelta(double lat, double lng) {
