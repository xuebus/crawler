...
private[crawler] class CrawlerDTWorker(name: String,
                                        var callback: () => Long,
  ...
  var cacheManager = CrawlerDTWorker.initCache(workerName, expiredTime)
...
private[crawler] object CrawlerDTWorker {
